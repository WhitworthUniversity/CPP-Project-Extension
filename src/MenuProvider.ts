		...
		return new Promise(resolve => {
			if ( this._toolChain == "CPP" ) {
				...
				resolve( [
					...
					new Dependency( "Make Assembler Project Files in the Folder...", 
									"command_createAsmProj", vscode.TreeItemCollapsibleState.None, 
									{ command: 'extension.createAsmProj', 
									title: '"Make Assembler Project Files', 
									arguments: [] 
								} ),
